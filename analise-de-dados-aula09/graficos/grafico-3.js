...
function processarDados(dados) {
    ...
    const valores = ['600','550','450','350','300','250','200','150','100']
    const labels = ['Arroz e feijão','Churrasco','Pão de queijo','Moqueca','Acarajé','Feijoada','Pizza','Tapioca']
    const data = [
        {
            values: valores,
            labels: labels,
    ...
    const layout = {
        ...
        height: 700,
        title: {
            text: 'Comidas mais consumidas no Brasil ',
            x: 0,
            font: {
    ...
    incluirTexto(`As comidas mais consumidas no Brasil variam conforme a região, essas opções refletem a diversidade e a riqueza da culinária brasileira.`)
}
